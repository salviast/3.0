...
try:
    ...
    X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.3, random_state=35) # 30% для теста

    # 3. Обучение модели
    mlp = MLPClassifier(hidden_layer_sizes=(100,), max_iter=500, solver='adam', random_state=35) # Настройка параметров
